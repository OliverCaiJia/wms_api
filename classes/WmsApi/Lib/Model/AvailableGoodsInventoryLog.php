...
class AvailableGoodsInventoryLog extends ModelBase
{
    ...
    /**
     * Method to set the value of field available_goods_id
     *
     * @param integer $available_goods_id
     * @return $this
     */
    public function setAvailableGoodsId($available_goods_id)
    {
        $this->available_goods_id = $available_goods_id;
    ...
    /**
     * Returns the value of field available_goods_id
     *
     * @return integer
     */
    public function getAvailableGoodsId()
    {
        return $this->available_goods_id;
    }
    ...
    const CACHE_KEY_RULE_LIST_BY_AVAILABLE_GOODS_ID = "list_by_available_goods_id";
    /**
     * @return array
     */
    static protected function getNonUniqueCacheKeyRules()
    {
        return [
            ...
            self::CACHE_KEY_RULE_LIST_BY_AVAILABLE_GOODS_ID => ['available_goods_id'],
        ];
    }
	 ...
	 * @return static[]
	 */
	static public function listByAvailableGoodsId($availableGoodsId)
	{
		$do = new ModelQueryDO();
		$do->setConditions("available_goods_id = :available_goods_id:");
		$do->setBind([
			"available_goods_id" => $availableGoodsId,
		]);
		$do->setOrderBy("id DESC");
		$do->setCacheKeyRule(self::CACHE_KEY_RULE_LIST_BY_AVAILABLE_GOODS_ID);
