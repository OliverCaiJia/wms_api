...
class SellerPlatformGoods extends ModelBase
{
    ...
    {
        return ["seller_id,platform_source_id,unique_code","seller_goods_id,platform_source_id"];
    }
	 ...
	 * @return static[]
	 */
	public static function listByPlatformSourceIdAndSellerId($platformSourceId, $sellerId)
	{
		$do = new ModelQueryDO();
