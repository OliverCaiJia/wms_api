...
class SellerPlatformSource extends ModelBase
{
    ...
    /**
     * Method to set the value of field subscribe_service
     *
     * @param integer $subscribe_service
     * @return $this
     */
    public function setSubscribeService($subscribe_service)
    {
    ...
    /**
     * Method to set the value of field platform_user_id
     *
    ...
    /**
     * Returns the value of field subscribe_service
     *
     * @return integer
     */
    ...
    /**
     * Returns the value of field platform_user_id
     *
     * @return string
     */
    ...
    {
        return ["platform_source_id,seller_id"];
    }
