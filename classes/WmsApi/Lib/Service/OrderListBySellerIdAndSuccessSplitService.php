...
class OrderListBySellerIdAndSuccessSplitService extends ServiceBase
{
    /**
     * @var int
     */
    ...
    {
        $orderList = Order::listBySellerIdAndStatus($this->sellerId,OrderStatusEnum::SUCCESS_SPLIT);
